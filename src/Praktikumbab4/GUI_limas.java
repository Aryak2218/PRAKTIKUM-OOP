...
public class GUI_limas extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
    HitungLimas hgLimas = new HitungLimas();
    hgLimas.setLuasAlas(Double.parseDouble(txtLuasAlas.getText()));
    hgLimas.tinggi = Double.parseDouble(txtTinggi.getText());
    txtHasil.setText(Double.toString(hgLimas.volumeLimas()));
